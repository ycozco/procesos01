"""
Django settings for procesos project.
...
SECRET_KEY = 'ik0ew_wq#j2lls=u4^t*!+*=smbhv*nzm0$b0-bi2wvo+3zme5'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ['35.239.53.15','*']
...
WSGI_APPLICATION = 'procesos.wsgi.application'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'procesos',     # El nombre de tu base de datos en MySQL
